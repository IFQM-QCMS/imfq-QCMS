...
def get_plan_detail(plan_id):
    ...
    limits = {
        ...
        'api_limit': plan.limits.api_limit if plan.limits else 10000,
        'reports_limit': getattr(plan.limits, 'reports_limit', 100) if plan.limits else 100,
        'dashboards_limit': getattr(plan.limits, 'dashboards_limit', 10) if plan.limits else 10
    }
