...
const OctaQube = {
    ...
    setupMobileSidebar() {
        ...
        if (backdrop && sidebar && sidebar.parentElement === document.body) {
            if (sidebar.previousElementSibling !== backdrop) {
        ...
        // Native Swipe-to-close Touch Gesture on Drawer (tuned to not block vertical scroll)
